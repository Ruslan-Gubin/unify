...
export const metadata: Metadata = generateMetadata({
	...
	description:
		"Документация по первой версии кнопки в My UI Kit. Узнайте, как использовать и настраивать базовую версию кнопки.",
	keywords: [
		"кнопка",
		"v1",
		"компоненты",
		...
		<article className="article__page">
			...
			<InfoBlock
				...
				infoList={[
					{
						value:
							"Используйте опцию variantColor, чтобы изменить цвет кнопки. Вы можете задать значение teal, error, green, pink, blue.",
					},
				]}
			/>
			<div
