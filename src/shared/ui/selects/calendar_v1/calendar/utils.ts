export const weekList = ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс"];
...
const sundayWeekToMondayWeekDayMapEn: Record<number, number> = {
  0: 0,
  1: 1,
  2: 2,
  3: 3,
...
export const sundayWeekToMondayWeekDayMapRus: Record<number, number> = {
  0: 6,
  1: 0,
  2: 1,
  3: 2,
...
const getDayOfTheWeek = (date: Date, lang: "en" | "ru") => {
  ...
  const langMap: Record<"en" | "ru", number> = {
    en: sundayWeekToMondayWeekDayMapEn[day],
    ru: sundayWeekToMondayWeekDayMapRus[day],
  };
